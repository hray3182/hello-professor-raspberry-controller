...
if __name__ == "__main__":
    ...
    try:
        gate1_controller = GateController(sensor_name="入口", trig_pin=hc.GATE1_TRIG_PIN, echo_pin=hc.GATE1_ECHO_PIN, motor_pin=hc.GATE1_MOTOR_PIN)
        gate2_controller = GateController(sensor_name="出口", trig_pin=hc.GATE2_TRIG_PIN, echo_pin=hc.GATE2_ECHO_PIN, motor_pin=hc.GATE2_MOTOR_PIN)
